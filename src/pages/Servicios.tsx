    ...
    <div className="flex flex-col items-center justify-center py-16 mt-24 space-y-12">
      ...
      <div className="grid grid-cols-1 gap-12 px-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex flex-col items-center p-8 transition-all bg-white rounded-lg shadow-lg hover:shadow-2xl">
          <h2 className="mb-4 text-xl font-semibold text-blue-800">SERVICIO DE REFUERZO ACADÉMICO</h2>
          ...
          <p className="mt-4 text-gray-600">Ayuda a fortalecer conocimientos clave y mejorar el rendimiento escolar.</p>
        </div>
        
        
        <div className="flex flex-col items-center p-8 transition-all bg-white rounded-lg shadow-lg hover:shadow-2xl">
          <h2 className="mb-4 text-xl font-semibold text-green-800">SERVICIO DE EDUCACIÓN ESPECIAL</h2>
          <p className="mb-4 text-center text-gray-600">
          ...
          <p className="mt-4 text-gray-600">Mejora el bienestar y el aprendizaje de estudiantes con necesidades especiales.</p>
        </div>

        
        <div className="flex flex-col items-center p-8 transition-all bg-white rounded-lg shadow-lg hover:shadow-2xl">
          <h2 className="mb-4 text-xl font-semibold text-red-800">SERVICIO DE PROGRAMACIÓN Y TECNOLOGÍA</h2>
          <p className="mb-4 text-center text-gray-600">
          ...
          <p className="mt-4 text-gray-600">Ofrecemos formación para preparar a los estudiantes en el mundo tecnológico del futuro.</p>
        </div>
      </div>
